...
const Edit = ({ edit_item, fullname, set_fullname, temperature, set_temperature, email, set_email, phone_number, set_phone_number }) => {
    ...
    const submit_form = e => {
        ...
        edit_item({ fullname, temperature, email, phone_number })
